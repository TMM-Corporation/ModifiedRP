...
BlockImageLoader.init = function (tga) {
	...
	if (BlockImageLoader.META == null)
		BlockImageLoader.META = FileTools.ReadJSON("/sdcard/games/com.mojang/resource_packs/innercore-resources/textures/terrain_texture.json");
		// BlockImageLoader.META = JSON.parse(new java.lang.String(FileTools.ReadText()));
...
BlockImageLoader.getBlockBitmap = function (name, data) {
	...
	var path = "/sdcard/games/com.mojang/resource_packs/innercore-resources/";
	...
	return android.graphics.BitmapFactory.decodeFile(path + ".png");
};
